...
export class CardsEstabelecimentosComponent implements OnInit, OnDestroy {
  ...
  @Input() establishment: Establishment = {
    ...
    imageUrl: '/assets/fotos-estabelecimentos/boate1.jpg',
    gallery: ['/assets/fotos-estabelecimentos/boate1.jpg', '/assets/fotos-estabelecimentos/boate2.jpg', '/assets/fotos-estabelecimentos/boate3.jpg'],
    rating: 4.5,
    neighborhood: 'Centro',
    city: 'Rio de Janeiro',
